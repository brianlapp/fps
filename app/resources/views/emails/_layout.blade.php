...
<body>
    <table align='center' background='https://s3.amazonaws.com/swu-filepicker/4E687TRe69Ld95IDWyEg_bg_top_02.jpg'
        ...
        <tbody>
        <tr>
            <td style="display:none;font-size:1px;color:#333333;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;">
                Automatically Win Cash Prizes Instantly On {{config('app.name')}}!
                </td>
            <td>
                <!--[if mso | IE]>
                <v:rect style="mso-width-percent:1000;" xmlns:v="urn:schemas-microsoft-com:vml" fill="true"
                        stroke="false">
                    <v:fill src="https://s3.amazonaws.com/swu-filepicker/4E687TRe69Ld95IDWyEg_bg_top_02.jpg"
                            origin="0.5, 0" position="0.5, 0" type="tile"/>
                                                                    ...
                                                                    <tr>
                                                                        <td align='left'>
                                                                            <a href='{{url('/')}}'>
                                                                                <img align='left'
                                                                                     alt='{{config('app.name')}}'
                                                                                     height='33' padding='5px'
                                                                                     src='{{country_logos('logo.png')}}'
                                                                                     width='120'/>
                                                                            </a>
                                                                        </td>
                                                                        <td align='right' style='vertical-align:bottom;'
                                                                            width='34px'>
                                                                            <a href='{{config('app.socials.twitter')}}'>
                                                                        ...
                                                                        <td align='right' style='vertical-align:bottom;'
                                                                            width='34px'>
                                                                            <a href='{{config('app.socials.facebook')}}'>
    ...
    @if(isset($daily))
        <table align="center" border="0" cellpadding="0" cellspacing="0" style="margin-top: 10px; margin-bottom: 10px;">
            <tbody>
                <tr>
                    <td style="color: black; text-align: center; font-family:Oxygen, Helvetica neue, sans-serif;">
                        <span style="text-align: center; color: #828282;">
                            New postal codes for the <b>Mini Draw</b> are drawn daily at: <br>
                            <b>8am</b>, <b>12am</b>, <b>4pm</b> and <b>8pm</b> EST!
                        </span>
                    </td>
                </tr>
            </tbody>
                            ...
                            <td style='direction:ltr;font-size:0px;padding:20px 0;text-align:center;vertical-align:top;'>
                                ...
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td style="vertical-align:top;width:600px;">
                                <![endif]-->
                                <!-- TODO: need to remove variable after test text -->
                                @if(isset($daily) && isset($remove_after_test))
                                    <div class='dys-column-per-100 outlook-group-fix'
                                         style='direction:ltr;display:inline-block;font-size:13px;text-align:left;vertical-align:top;width:100%;'>
                                        <table border='0' cellpadding='0' cellspacing='0' role='presentation'
                                            ...
                                            <tr>
                                                <td align='center'
                                                    ...
                                                    <img style="max-height: 200px" alt=""
                                                         src="{{asset('images/reminder-graphic.jpg')}}">
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
