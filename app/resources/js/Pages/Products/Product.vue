<template>
    ...
    <div class="container mx-auto mt-8 p-4 flex flex-col">
        ...
        <!-- Description Section -->
        <div class="mt-8"  v-if="product.long_description">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">Product Description</h2>
            <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 ">
                <div class="text-gray-700 dark:text-gray-300 leading-relaxed article-content" v-html="product.long_description"
                    />
                <!-- Buy & Deal Buttons -->
                <div class="flex gap-x-4 gap-y-4 flex-wrap" v-if="product.affiliate_links?.length > 0">
                    <a :href="link.url" target="_blank" v-for="link in product.affiliate_links"
