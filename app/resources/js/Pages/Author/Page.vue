    ...
    <MainLayout>
        ...
        <section class="mt-5 ">
            ...
            {{author.firstName}}!
                        ...
                        <img
                            class="mx-auto w-1/2 sm:max-w-sm rounded-full mt-8 dark:ring-gray-500 ring-8 ring-white shadow-md"
                            :src="author.avatar"
                            :alt="author.name"
                            height="400"
                            width="400"/>
                    ...
                    <div class="mt-10 text-center mx-auto">
                        ...
                        <div>
                            <h3 class="text-xl font-light text-gray-600 dark:text-neutral-300">Title: {{ author.title }}</h3>
                        </div>
                        <div class="p-4">
                            <p
                                class="text-lg text-gray-600 dark:text-neutral-400 bg-white dark:bg-gray-800 rounded-md shadow-sm p-4"
                                data-ai-key="content"
                                data-ai-type="html" v-html="author.bio">
                            </p>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    data() {
        return {
            feedUrl: route('author.feed', this.author.slug)
        }
    },
}
</script>
