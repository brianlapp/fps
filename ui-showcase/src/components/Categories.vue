  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-center mb-10">
      <h2 class="text-3xl font-extrabold tracking-tight sm:text-4xl">
        <span class="block bg-gradient-to-r from-green-500 to-blue-400 bg-clip-text text-transparent">Browse by Category</span>
      </h2>
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 lg:gap-6">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg hover:transform hover:scale-[1.05]">
        ...
        <div class="p-4 text-center">
          ...
          <a href="#" class="text-sm text-blue-600 dark:text-blue-400 hover:underline mt-1 inline-block">View Resources</a>
        </div>
      </div>
